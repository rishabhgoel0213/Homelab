/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-file .dev.vars.example` (hash: 3dee71954a65ce23f8f5d798fea83eea)
// Runtime types generated with workerd@1.20260518.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	MESSAGES: R2Bucket;
	DB: D1Database;
	INBOX_DOMAIN: "inbox.therealrishabh.com";
	SINGLEMAIL_API_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INBOX_DOMAIN" | "SINGLEMAIL_API_TOKEN">> {}
}
