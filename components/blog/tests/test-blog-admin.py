...
SCRIPT = Path(os.environ.get("BLOG_ADMIN_SCRIPT", "/srv/ops/components/blog/bin/blog-admin.py"))
ASSETS = Path(os.environ.get("BLOG_ADMIN_ASSETS", "/srv/ops/components/blog/assets"))
