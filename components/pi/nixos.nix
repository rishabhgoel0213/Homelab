...
let
  ...
  piPackage = pkgs.callPackage ./package.nix { };
  piCourierPackage = pkgs.callPackage ./courier-package.nix { };
  ...
  config = {
    ...
    systemd.services.pi-auto-update = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${homelab.paths.opsRoot}/components/pi/bin/auto-update";
      };
    };
